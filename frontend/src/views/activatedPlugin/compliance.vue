  ...
  <div class="pr-5 iframe-container">
    ...
    <n-card class="overlay-text" >
      ...
      <div class="heading-text p-7">
        <n-text class="text-lg font-bold">Compliance</n-text>
      </div>
    </n-card>
...
const iframeUrl = computed(() => {
  ...
  return `https://10.0.34.212:3000/d/cdnr88skurxfkd/edr-compliance?from=2024-12-10T00:38:28.980Z&to=2024-12-10T06:38:28.981Z&var-Filters=&var-agent_name=$__all&theme=${theme}`;
});
