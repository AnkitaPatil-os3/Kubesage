  ...
  <div class="pr-5 iframe-container">
    ...
    <n-card class="overlay-text" >
      ...
      <div class="heading-text p-7">
        <n-text class="text-lg font-bold">Summary</n-text>
      </div>
    </n-card>
...
const iframeUrl = computed(() => {
  ...
  return `https://10.0.34.212:3000/d/ednr88j8zffnk/edr-summary?from=2024-12-07T07:04:41.904Z&to=2024-12-07T08:04:41.904Z&var-agent_name=$__all&var-rule_level=7&var-Filters=&theme=${theme}`;
});
