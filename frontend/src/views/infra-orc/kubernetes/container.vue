  ...
  <div class="pr-5 iframe-container">
    ...
    <n-card class="overlay-text">
      <div class="heading-text p-7">
        <n-text class="text-lg font-bold">Cluster Container Details</n-text>
      </div>
    </n-card>
...
const iframeUrl = computed(() => {
  ...
  return `https://10.0.34.212:3000/d/bbfd65c0-2de8-4348-8f61-9b1fb2981ed1/kub-cluster-container-details?orgId=1&from=now-10m&to=now&var-DS=be964rwb0rbpce&theme=${theme}`;
});
