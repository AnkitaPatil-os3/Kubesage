  ...
  <div class="pr-5 iframe-container">
    ...
    <n-card class="overlay-text">
      <div class="heading-text p-7">
        <n-text class="text-lg font-bold">Cluster Overview</n-text>
      </div>
    </n-card>
...
const iframeUrl = computed(() => {
  ...
  return `https://10.0.34.212:3000/d/fdongibf4r7r4d/kub-cluster-overview?orgId=1&from=now-10m&to=now&var-DS=be964rwb0rbpce&theme=${theme}`;
});
