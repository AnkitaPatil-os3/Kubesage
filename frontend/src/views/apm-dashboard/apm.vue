  ...
  <div class="pr-5 iframe-container">
    ...
    <n-card class="overlay-text" >
      ...
      <div class="heading-text p-7">
        <n-text class="text-lg font-bold">APM Dashboard</n-text>
      </div>
    </n-card>
...
const iframeUrl = computed(() => {
  ...
  return `https://10.0.34.212:3000/d/e0701985-a623-4e62-9fae-f5094244d065/beyla-red-metrics?from=now-30m&to=now&var-datasource=fe4eeqvcnhce8a&var-Service=$__all&var-job=$__all&var-instance=$__all&refresh=30s&theme=${theme}`;
});
