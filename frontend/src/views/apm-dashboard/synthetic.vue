  ...
  <div class="pr-5 iframe-container">
    ...
    <n-card class="overlay-text">
      ...
      <div class="heading-text p-7">
        <n-text class="text-lg font-bold">Synthetic Dashboard</n-text>
      </div>
    </n-card>
...
const iframeUrl = computed(() => {
  ...
  return `https://10.0.35.220:3000/d/EHyn7ueZk/synthetic-monitoring-ping?orgId=1&from=now-30m&to=now&timezone=browser&var-probe=$__all&var-job=&var-instance=http:%2F%2F10.0.35.135:8080%2F&refresh=1m&theme=${theme}`;
});
