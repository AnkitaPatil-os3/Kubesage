...
.action-btn:hover, .toggle-theme-btn:hover {
    background-color: #f3f4f6;
    color: #4f46e5;
}
...
.action-btn:hover {
    color: #ef4444; /* Red color on hover for clear action */
}
...
.main-chat {
    ...
    position: relative;
    width: calc(100% - 280px); /* Default width with sidebar visible */
}
