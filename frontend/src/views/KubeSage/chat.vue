<template>
    <div class="app-container" :class="{ 'dark-mode': isDarkMode }">
        ...
        <!-- Main Chat Section -->
        <div class="main-chat" :class="{ 'full-width': !isSidebarVisible, 'with-minimized-sidebar': isMinimized && isSidebarVisible }">
            <!-- Chat Header -->
            ...
            <div v-if="activeChat.messages.length === 0" class="welcome-screen">
                <div class="welcome-content">
                    ...
                    <p>Your AI assistant for Kubernetes operations and troubleshooting</p>
                    ...
                    <div class="suggestion-grid">
                        ...
                        <div class="suggestion-card" @click="usePrompt('Troubleshoot pod crashes in namespace default')">
                        ...
                        <div class="suggestion-card" @click="usePrompt('Explain best practices for Kubernetes security')">
            ...
            <div class="chat-input-container">
                ...
                <div class="input-footer">
                    <span class="disclaimer">KubeSage may produce inaccurate information. Verify critical operations.</span>
                </div>
            </div>
        </div>
    </div>
...
@media (max-width: 768px) {
    ...
    .minimize-btn {
        display: none; /* Hide on mobile, just use the hamburger toggle */
    }
