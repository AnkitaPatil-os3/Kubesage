        ...
        <n-layout class="app-container" :class="{ 'dark-mode': isDarkMode }">
            <n-layout-header class="dashboard-header">
                <div class="header-content">
                    ...
                    <n-button type="primary" @click="openModal">
                        <i class="fas fa-plus-circle"></i> Add New Backend
                    </n-button>
                </div>
            </n-layout-header>
            ...
            <n-layout-content class="backend-dashboard">
                ...
                <n-card class="backend-table-container">
                    <div class="table-header">
                        ...
                        <div class="backend-stats">
                            <n-tag type="info" round class="backend-count">
                    ...
                    <n-data-table :columns="columns" :data="filteredBackends" :pagination="pagination" :bordered="false" class="backend-table" />
                </n-card>
                ...
                <n-modal
                    ...
                    preset="card"
                    :bordered="false"
                    class="custom-modal create-backend-modal"
                    :style="{
                        '--modal-color': '#10BC3B',
                    ...
                    <n-form :model="formData" :rules="rules" ref="formRef">
                        ...
                        <n-form-item label="Base URL" path="base_url" required>
                            <n-input 
                                ...
                                :class="{'error-field': baseUrlError}"
                                class="modal-input"
                            >
                                <template #prefix>
...
.backend-count {
  ...
  align-items: center;
  gap: 8px;
  background: rgba(74, 240, 32, 0.1);
  border: 1px solid #1bb664;
}
