<template>
  <div class="pr-5 iframe-container">
    ...
    <n-card class="overlay-text" :class="{ 'dark-overlay': isDark }">
      ...
      <div class="heading-text p-7">
        <n-text class="text-lg font-bold">Windows Dashboard</n-text>
      </div>
    </n-card>
...
const iframeUrl = computed(() => {
  ...
  return `https://10.0.34.212:3000/d/Kdh0OoSG/windows-exporter-dashboard?from=now-30m&to=now&var-job=integrations%2Fwindows&var-hostname=$__all&var-instance=WIN-E2SI4L8F05I&var-show_hostname=WIN-E2SI4L8F05I&theme=${theme}`;
});
