<template>
    <div class="pr-5 iframe-container">
      ...
      <n-card class="overlay-text" >
        ...
        <div class="heading-text p-7">
          <n-text class="text-lg font-bold">MongoDB Dashboard</n-text>
        </div>
      </n-card>
  ...
  const iframeUrl = computed(() => {
    ...
    return `https://10.0.34.212:3000/d/68bDO-m7/mongodb-instance?orgId=1&from=now-10m&to=now&var-instance=${instanceName}&theme=${theme}`;
  });
