...
export const CarbonEmissionDashboard: React.FC<CarbonEmissionDashboardProps> = ({ selectedCluster }) => {
    ...
    const dashboardUrl = React.useMemo(() => {
        ...
        const baseUrl = "https://10.0.32.108:3000/grafana-monitoring/d/NhnADUW4zIB/greenops-overview";
                ...
                <Card className="bg-warning-50 dark:bg-warning/10 border border-warning/20">
                    <CardBody className="text-center py-8">
                        ...
                        <p className="text-foreground-500 mb-4">
                            Please select a cluster from the dropdown above to view carbon emission data.
                        </p>
                        <Button
                            color="warning"
                            variant="flat"
                        ...
                        >
                                    ...
                                    <div className="flex flex-col items-center gap-4">
                                        ...
                                        <div className="text-center">
                                            ...
                                            <p className="text-sm text-foreground-500">
                                                Initializing carbon emission analysis for {selectedClusterName}...
                                            </p>
                            ...
                            {dashboardUrl && (
                                <iframe
                                    ...
                                    title={`Carbon Emission Dashboard - ${selectedClusterName}`}
                ...
                <Card className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
                    <CardBody className="flex flex-row items-center gap-3 py-4">
                        <div className="w-10 h-10 bg-green-500/20 rounded-full flex items-center justify-center">
                            <Icon icon="mdi:leaf" className="text-green-500" />
                        </div>
                        <div>
